...
**reason** | Option<[**models::OrderCancelReason**](OrderCancelReason.md)> |  | [optional]
**replaced_by_order_id** | Option<**i32**> | The ID of the Order that replaced this Order (only provided if this Order was cancelled for replacement). | [optional]
